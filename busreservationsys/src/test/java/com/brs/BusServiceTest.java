...
public class BusServiceTest{
	...
	@Test
	public void viewAllBusTest() throws BusNotFoundException {
		when(busrepo.findAll()).thenReturn(BusList);
		Assertions.assertEquals(3,busservice.viewAllBus().size());
	}

	@Test
	public void updateBusTest() throws BusNotFoundException{
	...
	@Test
	public void viewBusByIdTest() throws BusNotFoundException {
		when(busrepo.findById(bus1.getBusId())).thenReturn(Optional.of(bus1));
	    Assertions.assertEquals(bus1, busservice.viewBus(bus1.getBusId()));	
		}
	
	@Test
	public void deleteBusTest() throws BusNotFoundException {
		when(busrepo.findById(bus1.getBusId())).thenReturn(Optional.of(bus1));
